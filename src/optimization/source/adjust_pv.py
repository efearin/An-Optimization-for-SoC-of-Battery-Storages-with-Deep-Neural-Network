...
df = pd.read_csv('../result/forecast/g_dynamic_mip_battery_pv.csv',index_col=0)
...
df.to_csv('../result/adjusted/g_dynamic_mip_battery_pv.csv')

########

df = pd.read_csv('../result/adjusted/g_dynamic_mip_battery_pv.csv', index_col=0)
costdf = pd.read_csv('../result/forecast/g_dynamic_mip_battery_pv_cost.csv', index_col=0)
daily_cost = []
for x in range(360):
...
costdf.to_csv('../result/adjusted/g_dynamic_mip_battery_pv_cost.csv')
